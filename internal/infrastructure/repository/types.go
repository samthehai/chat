...
func (ni NullInt64) MarshalJSON() ([]byte, error) {
	...
	if err != nil {
		return jsn, fmt.Errorf("postgres could not marshal NullInt64: %w", err)
	}
...
func (ni NullInt64) UnmarshalJSON(b []byte) error {
	if err := json.Unmarshal(b, &ni.Int64); err != nil {
		return fmt.Errorf("postgres NullInt64 unmarshal error: %w", err)
	}
...
func (nb NullBool) UnmarshalJSON(b []byte) error {
	if err := json.Unmarshal(b, &nb.Bool); err != nil {
		return fmt.Errorf("postgres NullBool unmarshal error: %w", err)
	}
...
func (nf NullFloat64) UnmarshalJSON(b []byte) error {
	if err := json.Unmarshal(b, &nf.Float64); err != nil {
		return fmt.Errorf("postgres NullFloat64 unmarshal error: %w", err)
	}
...
func (ns NullString) MarshalJSON() ([]byte, error) {
	...
	if err != nil {
		return jsn, fmt.Errorf("postgres could not marshal NullString: %w", err)
	}
...
func (ns NullString) UnmarshalJSON(b []byte) error {
	if err := json.Unmarshal(b, &ns.String); err != nil {
		return fmt.Errorf("postgres NullString unmarshal error: %w", err)
	}
...
func (nt NullTime) UnmarshalJSON(b []byte) error {
	if err := json.Unmarshal(b, &nt.Time); err != nil {
		return fmt.Errorf("postgres NullTime unmarshal error: %w", err)
	}
